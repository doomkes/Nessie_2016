 ...
 */
MyIterativeRobot::MyIterativeRobot()
...
void MyIterativeRobot::Prestart() {
 ...
 */
void MyIterativeRobot::StartCompetition()
{
 ...
 */
void MyIterativeRobot::RobotInit()
{
 ...
 */
void MyIterativeRobot::DisabledInit()
{
	printf("Default %s() method... Overload me!\n", __FUNCTION__);
}
 ...
 */
void MyIterativeRobot::AutonomousInit()
{
	printf("Default %s() method... Overload me!\n", __FUNCTION__);
}
 ...
 */
void MyIterativeRobot::TeleopInit()
{
    printf("Default %s() method... Overload me!\n", __FUNCTION__);
}
 ...
 */
void MyIterativeRobot::TestInit()
{
    printf("Default %s() method... Overload me!\n", __FUNCTION__);
}
 ...
 */
void MyIterativeRobot::DisabledPeriodic()
{
 ...
 */
void MyIterativeRobot::AutonomousPeriodic()
{
	static bool firstRun = true;
	if (firstRun)
	{
 ...
 */
void MyIterativeRobot::TeleopPeriodic()
{
	static bool firstRun = true;
	if (firstRun)
	{
 ...
 */
void MyIterativeRobot::TestPeriodic()
{
    static bool firstRun = true;
    if (firstRun)
    {
